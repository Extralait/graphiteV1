...
`owner` | ***object(user_in_list)*** | Владелек коллекции (такой же, как при получении [списка пользователей](#получение-списка-пользователей)
...
### Получение специальных коллекций
