    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('drop', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='likes', to='api.drop', verbose_name='Drop')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('drop', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='views', to='api.drop', verbose_name='Drop')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='views', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
                'verbose_name': 'View',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('drop_owner', 'drop'), name='unicue_user_drop'),
        ),
        migrations.AddConstraint(
            model_name='like',
        ...
        migrations.AddConstraint(
            model_name='dropview',
            constraint=models.UniqueConstraint(fields=('user', 'drop'), name='unique_user_views'),
        ),
    ]
