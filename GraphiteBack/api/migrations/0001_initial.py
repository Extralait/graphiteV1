# Generated by Django 3.2.9 on 2021-11-11 17:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='UserGallerySubscription',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('gallery', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.gallery', verbose_name='Gallery')),
        ...
        migrations.AddField(
            model_name='user',
            name='galleries',
            field=models.ManyToManyField(related_name='user_galleries', through='api.UserGallery', to='api.Gallery', verbose_name='Galleries'),
        ),
        migrations.AddField(
            model_name='user',
            name='galleries_subscriptions',
            field=models.ManyToManyField(related_name='user_galleries_subscriptions', through='api.UserGallerySubscription', to='api.Gallery', verbose_name='Galleries subscribers'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
        ...
        migrations.AddField(
            model_name='user',
            name='profile_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.profiletype', verbose_name='Profile Type'),
        ),
        migrations.AddField(
            model_name='user',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='_api_user_users_subscriptions_+', through='api.UserUserSubscription', to=settings.AUTH_USER_MODEL, verbose_name='Users subscribers'),
        ),
        migrations.AddField(
            model_name='user',
            name='verify_status',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.verifystatus', verbose_name='Verify Status'),
        ),
    ]
