# Generated by Django 3.2.9 on 2021-11-15 13:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sell_type', models.CharField(blank=True, choices=[('wax', 'WAX'), ('anchor', 'Anchor')], max_length=20, null=True, verbose_name='Sell type')),
                ('sell_count', models.IntegerField(default=0, verbose_name='Sell count')),
                ('all_sell_count', models.IntegerField(default=0, verbose_name='All sell count')),
                ('init_cost', models.IntegerField(default=0, verbose_name='Init cost')),
                ('min_rate', models.IntegerField(default=0, verbose_name='Min rate')),
                ...
                ('to_sell', models.BooleanField(default=False, verbose_name='To sell')),
                ('url_landing', models.CharField(blank=True, max_length=256, null=True, verbose_name='Landing URL')),
                ('auction_deadline', models.DateTimeField(auto_now=True, verbose_name='Auction deadline')),
                ('royalty', models.FloatField(default=0, validators=[django.core.validators.MaxValueValidator(100), django.core.validators.MinValueValidator(0)], verbose_name='Royalty')),
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='parent_drop', to='api.drop', verbose_name='Parent')),
            ],
            options={
                'verbose_name': 'Drop',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('collection', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.collection', verbose_name='collection')),
                ('subscriber', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Subscriber')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('drop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.drop', verbose_name='Drop')),
                ('drop_owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='owner_drop', to=settings.AUTH_USER_MODEL, verbose_name='Drop owner')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('collection', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.collection', verbose_name='collection')),
                ('collection_owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='collection_ovner', to=settings.AUTH_USER_MODEL, verbose_name='Clloection owner')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('drop', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='drop_views', to='api.drop', verbose_name='Drop')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='drop_views', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
                'verbose_name': 'View',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('drop', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='drop_likes', to='api.drop', verbose_name='Drop')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='drop_likes', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('collection', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='collection_views', to='api.collection', verbose_name='Collection')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='collection_views', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
                'verbose_name': 'View',
                'verbose_name_plural': 'Views',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('collection', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='collection_likes', to='api.collection', verbose_name='Collection')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='collection_likes', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('drop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.drop', verbose_name='Drop')),
                ('drop_collection', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='collection_drop', to='api.collection', verbose_name='Drop collection')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='drops',
            field=models.ManyToManyField(related_name='collection', through='api.CollectionDrop', to='api.Drop', verbose_name='Drops'),
        ),
        migrations.AddField(
            model_name='user',
            name='collections',
            field=models.ManyToManyField(related_name='user_collections', through='api.OwnerCollection', to='api.Collection', verbose_name='Collections'),
        ),
        migrations.AddField(
            model_name='user',
            name='collections_subscriptions',
            field=models.ManyToManyField(related_name='collections_subscriptions', through='api.UserCollectionSubscription', to='api.Collection', verbose_name='Collections subscribers'),
        ),
        migrations.AddField(
            model_name='user',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('subscriber', 'collection'), name='unique_collection_subscriber'),
        ),
        migrations.AddConstraint(
            model_name='ownerdrop',
            constraint=models.UniqueConstraint(fields=('drop_owner', 'drop'), name='unique_user_drop'),
        ),
        migrations.AddConstraint(
            model_name='ownercollection',
            constraint=models.UniqueConstraint(fields=('collection_owner', 'collection'), name='unique_owner_collection'),
        ),
        migrations.AddConstraint(
            model_name='dropview',
            constraint=models.UniqueConstraint(fields=('user', 'drop'), name='unique_user_drop_views'),
        ),
        migrations.AddConstraint(
            model_name='droplike',
            constraint=models.UniqueConstraint(fields=('user', 'drop'), name='unique_user_drop_like'),
        ),
        migrations.AddConstraint(
            model_name='collectionview',
            constraint=models.UniqueConstraint(fields=('user', 'collection'), name='unique_user_collection_views'),
        ),
        migrations.AddConstraint(
            model_name='collectionlike',
            constraint=models.UniqueConstraint(fields=('user', 'collection'), name='unique_user_collections_like'),
        ),
        migrations.AddConstraint(
            model_name='collectiondrop',
            constraint=models.UniqueConstraint(fields=('drop_collection', 'drop'), name='unique_collection_drop'),
        ),
    ]
