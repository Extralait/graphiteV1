    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sell_count', models.IntegerField(blank=True, default=0, null=True, verbose_name='Sell count')),
                ('in_stock', models.IntegerField(blank=True, default=0, null=True, verbose_name='In Stock')),
                ('all_count', models.IntegerField(verbose_name='All count')),
                ('init_cost', models.FloatField(blank=True, default=0, null=True, verbose_name='Init cost')),
                ('min_rate', models.FloatField(blank=True, default=0, null=True, verbose_name='Min rate')),
